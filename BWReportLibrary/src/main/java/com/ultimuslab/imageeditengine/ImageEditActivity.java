...
import com.ultimuslab.imageeditengine.utils.FragmentUtil;

import static com.ultimuslab.imageeditengine.ImageEditor.EXTRA_IMAGE_PATH;
...
public class ImageEditActivity extends BaseImageEditActivity
  ...
  @Override public void onImageCropped(Bitmap bitmap, Rect cropRect) {
    ...
    PhotoEditorFragment photoEditorFragment =
        (PhotoEditorFragment) FragmentUtil.getFragmentByTag(this, PhotoEditorFragment.class.getSimpleName());
